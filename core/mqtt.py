...
# Use system CA bundle — required in Debian slim Docker images (Fly.dev)
_ca_certs = "/etc/ssl/certs/ca-certificates.crt" if os.path.exists("/etc/ssl/certs/ca-certificates.crt") else None  # noqa
...
client.tls_set(ca_certs=_ca_certs, cert_reqs=ssl.CERT_REQUIRED)
